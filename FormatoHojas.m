function FormatoHojas(fileName)
...
while sheetIdx2 <= numSheets
    ...
    if or(sheetIdx>1,numSheets-sheetIdx2>0)
        ...
        if worksheets.Item(sheetIdx).UsedRange.Count == 1
            ...
            thisSheet = worksheets.Item(sheetIdx);
            theCell = thisSheet.Range('A1:A1');
            theCell.Font.Size = 14;
            theCell.Font.Bold = true;
            theCell.Font.Color = -4165632;
            
            theCol = thisSheet.Columns(1);
            theCol.ColumnWidth = 25;
